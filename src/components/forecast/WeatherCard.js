...
const WeatherCard = ({ data }) => {
	...
	const getWeatherIcon = () => {
		if (data.precipitation > 12 && data.temperature > 20) return rainSunny;
		if (data.precipitation > 12) return rain;
		if (data.precipitation > 5) return cloudy;
		if (data.wind > 10) return windy;
		return sunny;
	}
	const levelColor = () => {
