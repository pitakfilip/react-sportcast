        ...
        <Grid item container spacing={10}>
          ...
          <Grid item xs={6}>
            <Autocomplete
              ...
              renderInput={(params) => <TextField {...params} label={translate('location')} />}
            />
          </Grid>
        </Grid>
        ...
        <Grid item container justifyContent="space-between" alignItems="center">
          <Grid item xs={4}>
            <Button variant="outlined" startIcon={<Tune />} onClick={toggleAdvanced}>
              {tglAdv ? translate('simpleSearch') : translate('advancedSearch')}
            </Button>
          </Grid>
          <Grid item xs={4}>
            <Grid container justifyContent="flex-end" alignItems="center" spacing={4}>
              <Grid item alignItems="flex-end">
                <FormControlLabel checked={value.lowRain} onChange={lowRainChange} control={<Checkbox />} label={translate('lowPrecipitation')} />
              </Grid>
